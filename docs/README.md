# Documentação — Ticket Controller Spec
...
| Projeto | Índice |
|---------|--------|
| Plataforma cloud | [`specdriven-platform/docs/README.md`](../specdriven-platform/docs/README.md) |
| App desktop | [`SpecDriven/docs/README.md`](../SpecDriven/docs/README.md) |
